...
const pageUsuarios = async () => {
  ...
  try {
    ...
    return <Unauthorized user={session.user} permisos={menu[4].permisos} children={<ListaUsuarios usuariosData={listaDeUsuarios} rolesData={roles} estudiosData={estudios} />}/>;
